...
def _enrich_recommendation(rec: Recommendation, db: Session) -> RecommendationResponse:
    ...
    return RecommendationResponse(
        ...
        donor_latitude=rec.donor_facility.latitude if rec.donor_facility else None,
        donor_longitude=rec.donor_facility.longitude if rec.donor_facility else None,
        ...
        recipient_latitude=rec.recipient_facility.latitude if rec.recipient_facility else None,
        recipient_longitude=rec.recipient_facility.longitude if rec.recipient_facility else None,
